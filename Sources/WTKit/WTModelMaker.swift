...
public class WTModelMaker {
    public var commonKeywords:[String] = ["super","class","var","let","struct","func","private","public","return","import","protocol","default","open","Type","lazy","in","for","while","do","self","inout","@objc","open","fileprivate","default"]//常用的关键字命名修改,如有需要可以添加
